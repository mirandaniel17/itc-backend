											...
											<tr>
														...
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 75px;"><img src="https://23d71e983a.imgdist.com/pub/bfra/u016hpyl/5ai/t4c/zyj/itc_logo.png" style="display: block; height: auto; border: 0; width: 100%;" width="75" alt title height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
												...
												<td class="column column-2" width="75%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 5px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<table class="heading_block block-1" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad">
																<h1 style="margin: 0; color: #323f71; direction: ltr; font-family: 'Roboto', Tahoma, Verdana, Segoe, sans-serif; font-size: 29px; font-weight: 700; letter-spacing: normal; line-height: 200%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 58px;">Instituto Técnico Columbia</h1>
															</td>
														</tr>
													</table>
												</td>
											...
											<tr>
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-bottom: 5px; padding-top: 5px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<table class="paragraph_block block-1" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad">
																<div style="color:#101112;direction:ltr;font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:left;mso-line-height-alt:24px;">
																	<p style="margin: 0;">Gracias por registrarte. Por favor, verifica tu correo electrónico haciendo clic en el siguiente botón:</p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad">
																<div style="color:#101112;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0; margin-bottom: 16px;">Este enlace expirará en 60 minutos.</p>
																	<p style="margin: 0; margin-bottom: 16px;">Si no realizaste esta solicitud, por favor ignora este mensaje.</p>
																	<p style="margin: 0; margin-bottom: 16px;">Gracias,</p>
																	<p style="margin: 0;">El equipo de soporte</p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad">
																<div style="color:#101112;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:16.8px;">
																	<p style="margin: 0; margin-bottom: 16px;">Equipo de Soporte.</p>
																	<p style="margin: 0; margin-bottom: 16px;">Dirección:</p>
																	<p style="margin: 0; margin-bottom: 16px;">Av. 16 de Julio (El Prado)</p>
																	<p style="margin: 0; margin-bottom: 16px;">Nro. 1490 Edif. Avenida Tercer Piso</p>
																	<p style="margin: 0;">Frente al Cine Monje Campero</p>
																</div>
															</td>
														</tr>
													</table>
